...
const sendDataToCloud = ()=>{
    ...
    _bleuio.at_findscandata("02010609FF0", 6).then((data)=>{
        ...
        if (theAdvData && theAdvData.length > 0) {
            ...
            for(let i = 0; i < devArr.length; i++){
                for(let j = 0; j < theAdvData.length; j++)if (theAdvData[j].split(" ")[0] == devArr[i]) {
...
},{"bleuio":"imH0e","firebase/database":"bpqHw"}],"imH0e":[function(require,module,exports) {
...
},{}],"bpqHw":[function(require,module,exports) {
...
var process = require("775c2e6517293367");
...
},{"775c2e6517293367":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dpgAG","6rimH"], "6rimH", "parcelRequire94c2")
