 ...
 * @param {number} e number of seconds scan should continue. Default 1 second.
 * @return {Promise} returns a promise
 * 
*/
(exports.at_findscandata = function (t = 1,e=1) {
...
(exports.at_scantarget = function (t, e = 1) {
    return writeCmd("AT+SCANTARGET=" + t+"="+e), readLoop("at_scantarget",e);
    ...
    for (arr = []; ; ) {
        ...
        switch ((a && arr.push(a), t)) {
            ...
            case "at_gattcwritewrb":
                ...
                break;
            case "at_gattcread":
                if (arr.includes("Size: 0")|| arr.includes("Size: 1")|| arr.includes("Size: 2")|| arr.includes("Size: 3")|| arr.includes("Size: 4")|| arr.includes("Size: 5")|| arr.includes("Size: 6")|| arr.includes("Size: 7")) return arr;
                break;
            case "at_gapconnect":
                if(arr.includes("handle_evt_gattc_browse_completed: conn_idx=0000 status=0"))    return arr;
                else if (arr.includes("DISCONNECTED.") || arr.includes("ERROR") || arr.includes("PAIRING SUCCESS")) return arr;
                break;
            case "at_getservices":
...
},{}],"bXWY":[function(require,module,exports) {
"use strict";
...
},{"@firebase/component":"bXWY","@firebase/logger":"uNCT","@firebase/util":"VOc0","idb":"ZUep"}],"yhnN":[function(require,module,exports) {
...
},{}],"HcIS":[function(require,module,exports) {
...
registerDatabase();
},{"@firebase/app":"qn02","@firebase/component":"bXWY","@firebase/util":"VOc0","@firebase/logger":"uNCT","process":"yhnN"}],"hCmk":[function(require,module,exports) {
"use strict";
...
},{"@firebase/database":"HcIS"}],"mpVp":[function(require,module,exports) {
"use strict";
...
var parseSensorData = function parseSensorData(data) {
...
var devArr = ['[C9:70:27:AF:01:44]', '[E7:49:6B:86:45:81]', '[D2:B1:28:3F:42:D4]'];
var advArr = [];

var sendDataToCloud = function sendDataToCloud() {
  advArr = []; //get the scan target device id by scanning for device.
  //my_dongle.at_scantarget('[1]E7:49:6B:86:45:81,[1]C9:70:27:AF:01:44,[1]D2:B1:28:3F:42:D4',10).then((data)

  my_dongle.at_findscandata('5B070509', 6).then(function (data) {
    ...
    if (theAdvData && theAdvData.length > 0) {
      ...
      for (var i = 0; i < devArr.length; i++) {
        for (var j = 0; j < theAdvData.length; j++) {
      ...
      var airQualityData1 = parseSensorData(advArr[0]);
      var airQualityData2 = parseSensorData(advArr[1]);
      var airQualityData3 = parseSensorData(advArr[2]);
      console.log('airQualityData1', airQualityData1);
      console.log('airQualityData2', airQualityData2);
      console.log('airQualityData3', airQualityData3); //let advData = theAdvData[0].split("[ADV]: ")
      ...
      var ref = database.ref("noise_records"); //pushing the object to the reference
...
},{"bleuio":"okjw","firebase/database":"hCmk"}]},{},["mpVp"], null)
//# sourceMappingURL=/script.fd5b374a.js.map